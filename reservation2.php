            ...
            <form role="form" id="booking" data-toggle="validator">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($_GET['room_id'])){?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-info pull-right" href="index3.php?room_mang">Replan Booking</a>
                            </div>
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-info pull-right" href="index3.php?reservation">Replan Booking</a>
                            </div>
                            <div class="panel-body">
                                <div class="form-group col-lg-6">
                                    <label>Room Type</label>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="number" class="form-control" data-error="Enter Min 8 Digit" data-minlength="8" placeholder="Contact No" id="contact_no" required>
                                <div class="help-block with-errors"></div>
                            </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-success" href="index3.php?reservation">Okay</a>
            </div>
        </div>
